    ...
    <header class="header">
        <div class="container">
            <div class="header-line">
                <div class="header-phone">+38 (044) 299 27 66</div>
    ...
    <main class="main">
        <div class="container">
            ...
            <div class="form">
                <div class="date-inc">
                    <p>Дата заїзду</p>
                    <input type="text" id="datepicker" class="date-1">


                </div>
                <div class="date-out">
                    <p>Дата виїзду</p>
                    <input type="text" id="datepicker1" class="date-1">
        ...
        <div class="table-line">
            <div class="inform-line">
                <div class="text-inform-line">29 Серпня 2021</div>
                <div class="text-inform-line">1 Вересня 2021</div>
                <div class="text-inform-line status">Успішно</div>
                <div class="text-inform-line"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none">
                        <path fill="#AE8B70" d="M18.339 2.878h-4.161V2.2c0-1.213-.987-2.2-2.2-2.2H8.022c-1.213 0-2.2.987-2.2
                         ...
                         20h8.733a2.973 2.973 0 0 0 2.968-2.969V3.988h1.004a.553.553 0 0 0 .555-.555.553.553 0 0
                          ...
                          14.831a1.862 1.862 0 0 1-1.858 1.859H5.633a1.862 1.862 0 0 1-1.858-1.859V3.988h12.454v13.043h-.004Z"/><path fill="#AE8B70" d="M10 16.9a.553.553 0 0 0 .555-.555V6.534A.553.553 0 0 0 10 5.979a.553.553 0 0 0-.555.555v9.806c0 .309.247.56.555.56ZM6.377 16.287a.553.553 0 0 0 .556-.555v-8.59a.553.553 0 0 0-.556-.555.553.553 0 0 0-.555.555v8.59c0 .308.251.555.555.555ZM13.623 16.287a.553.553 0 0 0 .555-.555v-8.59a.553.553 0 0 0-.556-.555.553.553 0 0 0-.555.555v8.59c0 .308.247.555.556.555Z"/></svg>
                </div>
            </div>
            <div class="inform-line">
                <div class="text-inform-line">29 Серпня 2021</div>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-phone">
                    <p><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none">
                ...
                3.088.64 6.786 3.92 10.065c3.28 3.28 6.978 4.815 8.373 3.42l1.326-1.326c.488-.559.488-1.396 0-1.884Z"/></svg>
                ...
                3.088.64 6.786 3.92 10.065c3.28 3.28 6.978 4.815 8.373 3.42l1.326-1.326c.488-.559.488-1.396 0-1.884Z"/></svg>
                    ...
                    <p class="adr"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="14" fill="none">
                        ...
                        7.623a2.622 2.622 0 1 1 0-5.243 2.622 2.622 0 0 1 0 5.243Z"/></svg>
                        <a href="tel:+38 (044) 299 27 66" class="adr adress-footer">пр-т. В. Лобановського 25/16 Київ, Україна</a>
                    </p>
                </div>
            </div>
        </div>
